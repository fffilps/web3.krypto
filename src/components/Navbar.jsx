...
import kryptoLogoBlack from "../../images/web3_KryptoLogo.png"
import kryptoLogoWhite from "../../images/web3_Krypto_white.png"

import NavbarItem from "./NavbarItem";

// const NavbarItem = ({ title, classProps, link }) => {
//   return <a className={`mx-4 cursor-pointer ${classProps}`} target={"_blank"} href={link}>{title}</a>;
// };
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      <div className="md:flex-[0.5] flex-initial justify-center items-center">
        <img src={kryptoLogoWhite} alt="logo" className="w-32 cursor-pointer" />
      </div>
